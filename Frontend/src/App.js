        ...
        <div className='App'>
            <Router>
                ...
                <Routes>
                    ...
                    <Route path="/EmpAttendaceMark" element={<EmpAttendaceMark/>}></Route>
                    <Route path="/EmpViewAllAttendance" element={<EmpViewAllAttendance/>}></Route>
                    <Route path="/EmpAttendanceUpdate/:id" element={<EmpAttendanceUpdate/>}></Route>
                    <Route path="/EmpViewOneAttendance/:id" element={<EmpViewOneAttendance/>}></Route>
                    <Route path="/EmpLeaveFormCreate" element={<EmpLeaveFormCreate/>}></Route>
                    <Route path="/EmpViewAllLeaves" element={<EmpViewAllLeaves/>}></Route>
                    <Route path="/EmpLeaveEdit/:id" element={<EmpLeaveEdit/>}></Route>
                    <Route path="/EmpLeaveViewOne/:id" element={<EmpLeaveViewOne/>}></Route>
                    <Route path="/AdminCheckLeave/:id" element={<AdminCheckLeave/>}></Route>
                    <Route path="/AdminLeaveViewAll" element={<AdminLeaveViewAll/>}></Route>
